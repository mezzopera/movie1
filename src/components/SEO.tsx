...
const DEFAULT_TITLE = 'StreamVue - Watch Movies & TV Shows Online';
const DEFAULT_DESCRIPTION = 'Stream the latest movies and TV shows in HD quality. Watch anywhere, anytime with StreamVue.';
...
export default function SEO({
  ...
  const finalTitle = title ? `${title} - StreamVue` : DEFAULT_TITLE;
  ...
  return (
    <Helmet>
      ...
      <meta property="og:site_name" content="StreamVue" />
