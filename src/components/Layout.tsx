        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-8">
              <Link to="/" className="text-red-600 text-2xl font-bold flex items-center h-16">STREAMVUE</Link>
              <div className="hidden md:flex gap-6">
                <Link to="/" className="flex items-center gap-2 hover:text-red-600 transition-colors h-16">
                  <Home size={20} />
                  <span>Home</span>
                </Link>
                <Link to="/movies" className="flex items-center gap-2 hover:text-red-600 transition-colors h-16">
                  <Film size={20} />
                  <span>Movies</span>
                </Link>
                <Link to="/tv" className="flex items-center gap-2 hover:text-red-600 transition-colors h-16">
                  <Tv size={20} />
                  <span>TV Shows</span>
                </Link>
                <Link to="/genres" className="flex items-center gap-2 hover:text-red-600 transition-colors h-16">
                  <List size={20} />
                  <span>Genres</span>
                </Link>
              </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="hidden md:flex items-center gap-4">
                <a 
                  href="https://discord.gg/streamvue" 
                  target="_blank" 
                ...
                <a 
                  href="mailto:contact@streamvue.com" 
                  className="flex items-center justify-center h-10 w-10 rounded-lg hover:text-red-600 hover:bg-gray-800/50 transition-colors"
                >
                  <Mail size={20} />
                </a>
