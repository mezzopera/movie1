          ...
          <div className="max-w-xl">
            ...
            <div className="flex gap-3 sm:gap-4">
              <Link
                ...
                className="inline-flex items-center gap-2 bg-red-600 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-lg hover:bg-red-700 transition-colors text-sm sm:text-base"
              >
                <Play size={20} />
                Watch Now
              </Link>
